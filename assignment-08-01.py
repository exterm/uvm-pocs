...
# For γ = 3/2, generate n = 1000 sets each of N = 10, 10^2, 10^3, 10^4, 10^5, and 10^6 samples,
...
part = args.part  # execute part 'a' or 'b'. Added switch to save some execution time.
gamma = 3 / 2
n = 1000
...
if part == 'a':
    ...
    print("Saving output.")
    plt.savefig('output/assignment-08-01a.png', dpi=600)
...
# least squares. Report error estimates.
    ...
    plt.savefig('output/assignment-08-01b.png', dpi=600)
    plt.show()
